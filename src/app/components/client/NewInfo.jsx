      ...
      <div className="container_relative">
        ...
        <div className="form">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <input type="text" id="iden_curp" {...register("iden_curp", { required: "Este campo es obligatorio.", maxLength: { value: 18, message: "El campo solo admite 18 caracteres."}, pattern: { value: /^[A-Z0-9]+$/, message: "Solo se permiten letras mayúsculas y números." } })} />
            ...
            <input type="text" id="iden_rfc" {...register("iden_rfc", { required: "Este campo es obligatorio.", maxLength: { value: 12, message: "El campo solo admite 12 caracteres."}, pattern: { value: /^[A-Z0-9]+$/, message: "Solo se permiten letras mayúsculas y números." } })} />
            ...
            <input type="date" id="iden_fecha_nacimiento" {...register("iden_fecha_nacimiento", { required: "Este campo es obligatorio." })} />
            ...
            <input type="text" id="iden_nacionalidad" {...register("iden_nacionalidad", { required: "Este campo es obligatorio.", maxLength: { value: 50, message: "El campo solo admite 50 caracteres." } })} />
            ...
            <input type="text" name="iden_entidad" id="iden_entidad" {...register("iden_entidad", { required: "Este campo es obligatorio.", maxLength: { value: 50, message: "El campo solo admite 50 caracteres." } })} />
            ...
            <select id="iden_estado_civil" {...register("iden_estado_civil", { required: "Este campo es obligatorio." })} >
            ...
            <input type="tel" {...register("iden_telefono", { maxLength: { value: 10, message: "El campo solo admite 10 dígitos.", }, })} />
            ...
            <input type="email" id="iden_email" {...register("iden_email", { required: "Este campo es obligatorio.", maxLength: { value: 50, message: "El campo solo admite 50 caracteres" } })} />
            ...
            <input type="email" id="iden_email_alternativo" {...register("iden_email_alternativo", { maxLength: { value: 50, message: "El campo solo admite 50 caracteres.", }, })} />
            ...
            <select id="iden_area_dedicacion" {...register("iden_area_dedicacion", { required: "Este campo es obligatorio." })} >
              <option value="">Selecciona una opción</option>
            ...
            <select id="iden_disciplina_dedicacion" {...register("iden_disciplina_dedicacion", { required: "Este campo es obligatorio." })} >
              <option value="">Selecciona una opción</option>
              <option value="Arquitectura">Arquitectura</option>
