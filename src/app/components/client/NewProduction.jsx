    ...
    <Modal show={show} pathRedirect={pathname}>
      <div className="container_relative">
        ...
        <div className="form">
          ...
          <select {...register("pd_id", { required: "Este campo es obligatorio." })} className={`input-field ${errors.pd_id ? "input-error" : ""}`} id="pd_id" value={selectedOption} onChange={(e) => setSelectedOption(e.target.value)} >
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            {selectedOption === "1" && (
              <>
                ...
                <input className={`input-field ${errors.art_autores ? "input-error" : ""}`} {...register("art_autores", { required: "Este campo es obligatorio.", maxLength: { value: 100, message: "El campo solo admite 100 caracteres." }, })} id="art_autores" />
                ...
                <input className={`input-field ${errors.art_estado_actual ? "input-error" : ""}`} {...register("art_estado_actual", { required: "Este campo es obligatorio.", maxLength: { value: 10, message: "El campo solo admite 10 caracteres." }, })} id="art_estado_actual" />
                ...
                <input type="number" id="art_de_la_pagina" className={`input-field ${errors.art_de_la_pagina ? "input-error" : ""}`} {...register("art_de_la_pagina", { required: "Este campo es obligatorio.", maxLength: { value: 3, message: "El campo solo admite 3 caracteres." }, })} />
                ...
                <input type="number" id="art_a_la_pagina" className={`input-field ${errors.art_a_la_pagina ? "input-error" : ""}`} {...register("art_a_la_pagina", { required: "Este campo es obligatorio.", maxLength: { value: 3, message: "El campo solo admite 3 caracteres." }, })} />
                {errors.art_a_la_pagina && <span className="error">{errors.art_a_la_pagina.message}</span>}<br />

                <label htmlFor="art_pais">País *:</label><br />
                <input type="text" id="art_pais" className={`input-field ${errors.art_pais ? "input-error" : ""}`} {...register("art_pais", { required: "Este campo es obligatorio.", maxLength: { value: 20, message: "El campo solo admite 20 caracteres." }, })} />
                {errors.art_pais && <span className="error">{errors.art_pais.message}</span>}<br />

                <label htmlFor="art_volumen">Volumen *:</label><br />
                <input type="number" id="art_volumen" className={`input-field ${errors.art_volumen ? "input-error" : ""}`} {...register("art_volumen", { required: "Este campo es obligatorio.", maxLength: { value: 10, message: "El campo solo admite 10 caracteres." }, })} />
                ...
                <input type="date" id="art_fecha_publicacion" className={`input-field ${errors.art_fecha_publicacion ? "input-error" : ""}`} {...register("art_fecha_publicacion", { required: "Este campo es obligatorio." })} />
                ...
                <select id="art_tipo_articulo" className={`input-field ${errors.art_tipo_articulo ? "input-error" : ""}`} {...register("art_tipo_articulo", { required: "Este campo es obligatorio." })} >
                  <option value="">Selecciona una opción</option>
                ...
                <input type="text" id="art_titulo_articulo" className={`input-field ${errors.art_titulo_articulo ? "input-error" : ""}`} {...register("art_titulo_articulo", { required: "Este campo es obligatorio.", maxLength: { value: 100, message: "El campo solo admite 100 caracteres." }, })} />
                ...
                <input type="text" id="art_nombre_revista" className={`input-field ${errors.art_nombre_revista ? "input-error" : ""}`} {...register("art_nombre_revista", { required: "Este campo es obligatorio.", maxLength: { value: 100, message: "El campo solo admite 100 caracteres." }, })} />
                ...
                <input type="text" id="art_editorial" className={`input-field ${errors.art_editorial ? "input-error" : ""}`} {...register("art_editorial", { required: "Este campo es obligatorio.", maxLength: { value: 100, message: "El campo solo admite 100 caracteres." }, })} />
                ...
                <input type="text" id="art_issn" className={`input-field ${errors.art_issn ? "input-error" : ""}`} {...register("art_issn", { required: "Este campo es obligatorio.", maxLength: { value: 100, message: "El campo solo admite 100 caracteres." }, })} />
                ...
                <input type="text" id="art_direccion_electronica" className={`input-field ${errors.art_direccion_electronica ? "input-error" : ""}`} {...register("art_direccion_electronica", { maxLength: { value: 100, message: "El campo solo admite 100 caracteres." }, })} />
            ...
            {selectedOption === "2" && (
              <>
                ...
                <input {...register("lib_autores", { required: "Este campo es obligatorio.", maxLength: { value: 100, message: "El campo solo admite 100 caracteres." }, })} className={`input-field ${errors.lib_autores ? "input-error" : ""}`} id="lib_autores" />
                ...
                <select className={`input-field ${errors.lib_estado_actual ? "input-error" : ""}`} {...register("lib_estado_actual", { required: "Este campo es obligatorio." })} id="lib_estado_actual" >
                  <option value="">Selecciona una opción</option>
